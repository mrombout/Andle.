...
public class InternalBoldLexer extends Lexer {
    ...
    public final void mRULE_TEXT_T() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBold.g:350:13: ( ( 'a' .. '\\u00E5' | 'A' .. '\\u00C5' | ',' | '.' ) ( RULE_ID | RULE_WS )+ )
            // InternalBold.g:350:15: ( 'a' .. '\\u00E5' | 'A' .. '\\u00C5' | ',' | '.' ) ( RULE_ID | RULE_WS )+
            {
            ...
            // InternalBold.g:350:53: ( RULE_ID | RULE_WS )+
            int cnt1=0;
            loop1:
            do {
                int alt1=3;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBold.g:352:9: ( ( ' ' | '\\t' )+ )
            // InternalBold.g:352:11: ( ' ' | '\\t' )+
            {
            // InternalBold.g:352:11: ( ' ' | '\\t' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBold.g:354:14: ( ( '\\r' )? '\\n' )
            // InternalBold.g:354:16: ( '\\r' )? '\\n'
            {
            // InternalBold.g:354:16: ( '\\r' )?
            int alt3=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            // InternalBold.g:356:18: ( ( 'a' .. '\\u00E5' | 'A' .. '\\u00C5' ) ( 'a' .. '\\u00E5' | 'A' .. '\\u00C5' | '0' .. '9' | '!' | '?' )* )
            // InternalBold.g:356:20: ( 'a' .. '\\u00E5' | 'A' .. '\\u00C5' ) ( 'a' .. '\\u00E5' | 'A' .. '\\u00C5' | '0' .. '9' | '!' | '?' )*
            {
            ...
            // InternalBold.g:356:50: ( 'a' .. '\\u00E5' | 'A' .. '\\u00C5' | '0' .. '9' | '!' | '?' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBold.g:358:10: ( ( '0' .. '9' )+ )
            // InternalBold.g:358:12: ( '0' .. '9' )+
            {
            // InternalBold.g:358:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBold.g:360:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalBold.g:360:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalBold.g:360:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalBold.g:360:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalBold.g:360:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalBold.g:360:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalBold.g:360:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBold.g:362:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalBold.g:362:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalBold.g:362:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBold.g:364:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalBold.g:364:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalBold.g:364:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBold.g:366:16: ( . )
            // InternalBold.g:366:18: .
            {
            matchAny(); 
