 ...
 * </p>
 * <ul>
 *   <li>{@link Bold.impl.ParagraphImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphImpl extends MinimalEObjectImpl.Container implements Paragraph {
	...
	protected EClass eStaticClass() {
		return BoldPackage.Literals.PARAGRAPH;
	}
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<Node>(Node.class, this, BoldPackage.PARAGRAPH__NODES);
		}
		return nodes;
	}
