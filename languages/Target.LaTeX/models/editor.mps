...
<model ref="r:fdb01cb6-4fd3-46ca-a237-6812dfb3da83(Target.LaTeX.editor)">
  ...
  <node concept="24kQdi" id="7S_qEnN7WgT">
    ...
    <node concept="3EZMnI" id="7S_qEnN7WgV" role="2wV5jI">
      <node concept="3F0ifn" id="7S_qEnN7Wh2" role="3EZMnx">
        <property role="3F0ifm" value="\\documentclass{" />
      </node>
      <node concept="3F0A7n" id="7S_qEnN7Whc" role="3EZMnx">
        <ref role="1NtTu8" to="i3jy:7S_qEnN7WgJ" resolve="documentClass" />
      </node>
      <node concept="3F0ifn" id="7S_qEnN7Wj1" role="3EZMnx">
      ...
      <node concept="3F0ifn" id="7S_qEnN7WjL" role="3EZMnx">
        <property role="3F0ifm" value="\\begin{document}" />
        <node concept="pVoyu" id="7S_qEnN7WjU" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
      <node concept="3F0ifn" id="7S_qEnN7Wk7" role="3EZMnx">
        <property role="3F0ifm" value="" />
        <node concept="pVoyu" id="7S_qEnN7WkB" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
      <node concept="3F0ifn" id="7S_qEnN7Wks" role="3EZMnx">
        <property role="3F0ifm" value="\\end{document}" />
        <node concept="pVoyu" id="7S_qEnN7W$i" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
